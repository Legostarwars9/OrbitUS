...
Currently, only the players are synced, so all game progress is client-sided and will not be reflected on other clients. This will be changed in the future!
